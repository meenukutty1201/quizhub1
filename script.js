...
function text()
{
   textInput = document.getElementById('address').value;
  
   var submit1=document.getElementById('submit1');
   var address=document.getElementById('address').style.display="none";
   var videopage5=document.getElementById('videopage5').scrollIntoView();
...
function matches1()
{
   ...
   document.getElementById('qsn2').style.display="none";
   document.getElementById('qsn3').style.display="none";
   document.getElementById('qsn4').style.display="none";
   document.getElementById('qsn5').style.display="none";

   document.getElementById('matches2').style.display="none";
   document.getElementById('matches3').style.display="none";
   document.getElementById('matches4').style.display="none";
   document.getElementById('matches5').style.display="none";
   var videopage10=document.getElementById('videopage10').scrollIntoView();
   qsn1.style.background="grey";
   qsn1.style.color="black";
   match1.style.background="grey";
...
function matches2()
{
   ...
   document.getElementById('qsn1').style.display="none";
   document.getElementById('qsn3').style.display="none";
   document.getElementById('qsn4').style.display="none";
   document.getElementById('qsn5').style.display="none";

   document.getElementById('matches1').style.display="none";
   document.getElementById('matches3').style.display="none";
   document.getElementById('matches4').style.display="none";
   document.getElementById('matches5').style.display="none";
   ...
   var videopage10=document.getElementById('videopage10').scrollIntoView();
   qsn2.style.background="grey";
   qsn2.style.color="black";
   match2.style.background="grey";
...
function matches3()
{
   ...
   var videopage10=document.getElementById('videopage10').scrollIntoView();
   qsn3.style.background="grey";
   qsn3.style.color="black";
   match3.style.background="grey";
   match3.style.color="black";
   q9= true;
}

function matches4()
{
   var qsn4=document.getElementById("qsn4");
   var match4=document.getElementById("matches4");
   document.getElementById('qsn1').style.display="none";
   document.getElementById('qsn2').style.display="none";
   document.getElementById('qsn3').style.display="none";
   document.getElementById('qsn5').style.display="none";
   ...
   var videopage10=document.getElementById('videopage10').scrollIntoView();
   qsn4.style.background="grey";
   qsn4.style.color="black";
   match4.style.background="grey";
   match4.style.color="black";
   q9 = true;
}

function matches5()
{
   var qsn5=document.getElementById("qsn5");
   var match5=document.getElementById("matches5");
   ...
   document.getElementById('matches4').style.display="none";
   var videopage10=document.getElementById('videopage10').scrollIntoView();
   qsn5.style.background="grey";
   qsn5.style.color="black";
   match5.style.background="grey";
   match5.style.color="black";
   q9 = true;
}
